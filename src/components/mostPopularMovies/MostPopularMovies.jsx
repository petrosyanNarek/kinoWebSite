                          ...
                          <div className="movie row row-cols-1 row-cols-sm-1 row-cols-lg-1 row-cols-xl-2">
                            ...
                            <div className="col movies-info">
                              <div className="info">
                                ...
                                <p className="movies-story">
                                  <span className="movies-title">Genres :</span>
                                  <span className="movies-des">
                                    {popularMovies[0]?.genres?.map((ganre) => {
                                      return ganre.name + " | ";
                                    })}
                                  </span>
                                </p>
                                <p className="movies-story">
                                  <span className="movies-title">Rating :</span>
                                  <span className="movies-des">
                                ...
                                <p className="movies-story">
                                  ...
                                  <span className="movies-des">
                                    ...
                                    ratione doloremque vitae quaerat architecto
                                    ab ipsum? Accusantium sint mollitia fuga
                                    asperiores quidem vel esse quisquam,
                                    excepturi dolorum aspernatur sit adipisci
                                    eaque enim suscipit voluptatum. Minima error
                                    fugiat iste maiores amet similique,
                                    laudantium a distinctio hic, ut praesentium
                                    recusandae aut nemo libero porro eum
                                    mollitia voluptatem, reprehenderit impedit
                                    sequi accusantium! Impedit in quis deleniti
                                    delectus iusto sequi reiciendis rem veniam,
                                    et voluptatum earum. Minus sint suscipit
                                    quae itaque, exercitationem nemo nam fugiat
                                    qui facilis. Aperiam veritatis quidem,
